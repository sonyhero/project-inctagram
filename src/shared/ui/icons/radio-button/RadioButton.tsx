...
const SvgComponent = (
  { isChecked = true, ...props }: SVGProps<SVGSVGElement> & PropsType,
  ...
  >
    {isChecked ? (
      <>
        <g clipPath="url(#clip0_3663_10067)">
          <path
      ...
      <>
        <g clipPath="url(#clip0_3663_10068)">
          <path
...
export const RadioButton = memo(ForwardRef)
