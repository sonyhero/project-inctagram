...
export const ru: LocaleType = {
  ...
  auth: {
    ...
    signUp: {
      ...
      userNameExistError: 'Пользователь с таким именем пользователя уже существует',
      email: 'Адрес электронной почты',
      emailPlaceholder: 'введите ваш адрес электронной почты',
      emailExistError: 'Пользователь с этим адресом электронной почты уже существует',
      password: 'Пароль',
      passwordPlaceholder: 'введите ваш пароль',
